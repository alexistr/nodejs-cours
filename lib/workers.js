...
workers.validateCheckData = (originalCheckData) => {
  ...
  originalCheckData.successCodes = typeof(originalCheckData.successCodes) == 'object' && originalCheckData.successCodes instanceof Array && originalCheckData.length > 0 ? originalCheckData.successCodes : false;
...
workers.performCheck = (originalCheckData) => {
  ...
  let req = _moduleToUse.requests(requestDetails,(res) => {
